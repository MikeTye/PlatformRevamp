...
import { CompanySidebarMedia } from './CompanySidebarMedia';
import { CompanySidebarDocuments } from './CompanySidebarDocument';
...
export function CompanySidebarEditor({
    ...
    const handleCopyInvite = async () => {
        ...
        try {
            ...
            trackEvent('Company invite link copied', {
                company_id: company?.id,
                company_name: company?.displayName,
                source: 'company_sidebar_editor',
            });
                            ...
                            InputProps={{
                                startAdornment: (
                                    <InputAdornment position="start">
                                        <EmailRounded sx={{ fontSize: 16, color: 'grey.400' }} />
                                    </InputAdornment>
                                ),
                            }}
                        />
            ...
            case 'media':
                return (
                    <CompanySidebarMedia
                        ...
                        renderVisibilityToggle={renderVisibilityToggle}
                        renderUploadError={renderUploadError}
                    />
                );

            case 'documents':
                return (
                    <CompanySidebarDocuments
                        editingItem={editingItem}
                        docName={docName}
                        docType={docType}
