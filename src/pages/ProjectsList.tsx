            ...
            try {
                ...
                setProjects(
                    (data.items ?? []).map((project) => ({
                        ...project,
                        countryCode: resolveCountryCode(project.country, project.countryCode),
                    }))
                );
        ...
        <Box minHeight="100vh" bgcolor="white" display="flex" flexDirection="column">
            <Box bgcolor="white" borderBottom={1} borderColor="grey.200" flexShrink={0}>
                ...
                <Box px={3}>
                    <Tabs
                        value={activeTab}
                        onChange={(_, value: 'all' | 'my' | 'saved') => setActiveTab(value)}
                        textColor="primary"
                            ...
                            <Tab
                                ...
                                label={
                                    <Box display="flex" alignItems="center" gap={1}>
                                        {tab.label}
                                        <Chip
                                            label={counts[tab.value as keyof typeof counts]}
                                            size="small"
                                            sx={{
                                                height: 20,
                                                fontSize: '0.75rem',
